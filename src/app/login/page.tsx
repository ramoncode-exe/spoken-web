            ...
            <div className="bg-white w-full max-w-md md:w-[400px] rounded-lg p-6 flex flex-col shadow-lg">
                ...
                <form>
                    <div className="flex flex-col">
                        ...
                        <div className="justify-between text-[#848484] text-[14px] flex mt-2 items-center">
                            <div>
                    ...
                    <div className="text-center">
                        <button className="bg-[#f52986] text-white transform hover:-translate-y-1 transition p-2 rounded-sm w-full mt-6">Entrar</button>
                        <div>
                            <Link href="/signup" className="hover:underline text-[#848484] text-[14px]">Não tem conta? Criar uma conta</Link>
                        </div>
                    </div>
