...
export default function Home(){
    return(
        <main className="flex items-center p-1.5 w-11/12 mx-auto max-lg:flex-wrap-reverse font-poppins">
            <motion.div className="mb-8" initial={{ x: -200, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 2, ease:"easeOut" }}>
                ...
                <h1 className="text-[36px] font-bold mt-5 w-8/12"> Porque Não Falar <span className="text-[#9b18d4] text-[42px]">Inglês Ainda Hoje?</span></h1>
